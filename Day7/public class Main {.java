...
import java.util.stream.*;  // ✅ Needed for Stream API
...
class Main {
    ...
    public static void main(String[] args) {
        ...
        Employee e4 = new Employee(21, "name123", 75000.00, "support");
        Employee e5 = new Employee(17, "someName", 85000.00, "development");
        ...
        // ✅ Calculate average salary of employees in "development" department
